...
import com.romiiis.equallib_playground.MainClass;
import com.romiiis.equallib_playground.components.listView.ClassListView;
import com.romiiis.equallib_playground.components.listView.SaveResult;
import com.romiiis.equallib_playground.controllers.LoadObjectController;
import com.romiiis.equallib_playground.io.FileManager;
import com.romiiis.equallib_playground.util.EditorsUtil;
import com.romiiis.equallib_playground.util.JsonUtil;
...
public class MyTreeView extends TreeView<FieldNode> {
    ...
    /**
     * Saves the currently selected object to a file.
     * Prompts the user for a file name and shows a loading animation while saving.
     *
